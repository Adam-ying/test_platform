...
class QA:
    ...
    createComment = "mutation createComment($create: CommentEdit) {\n  createComment(create: $create) {\n    id\n  }\n}\n"
    resourceTaskDetail = "query resourceTaskDetail($req: UniqueIdReq) {\n  result: resourceTaskDetail(req: $req) {\n    id\n    create_time\n    update_time\n    last_task_status\n    task_id\n    reject_reason\n    reject_type\n    flow_template_id\n    flow_template_name\n    user_id\n    node_user\n  }\n}"
    resourceTaskDetailDelete = "mutation operateResource($req: OperateResourceReq_Input) {\n  operateResource(req: $req) {\n    id\n    code\n  }\n}"